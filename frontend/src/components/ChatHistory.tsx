  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="px-3.5 pt-3.5 pb-1.5 shrink-0">
        <span className="text-[10.5px] font-semibold text-ink-soft uppercase tracking-[.13em]">Recent</span>
      </div>
      ...
      <div className="flex-1 overflow-y-auto px-2 pb-2 space-y-1">
        ...
        {!loading && sessions.length === 0 && (
          <div className="flex flex-col items-center justify-center py-10 px-4 text-center gap-2">
            ...
            <p className="text-[11px] text-ink-faint">No research yet.</p>
          </div>
        )}
          ...
          return (
            ...
            >
              <div className="flex items-center gap-1.5">
                ...
                <span className="text-[10px] text-ink-faint">{relativeTime(session.latest)}</span>
              </div>
              <span className={`text-xs leading-snug line-clamp-2 ${isCurrent ? "text-ink" : "text-ink-soft"}`}>
